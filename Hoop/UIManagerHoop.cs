...
public struct UXHandleHoop
{
    public UIManagerHoop.InstructionUI InstructionalUI;
    public UIManagerHoop.InstructionGoals Goal;

    public UXHandleHoop(UIManagerHoop.InstructionUI ui, UIManagerHoop.InstructionGoals goal)
    {
        InstructionalUI = ui;
        Goal = goal;
    }
...
public class UIManagerHoop : MonoBehaviour
{
    [SerializeField]
    ...
    Queue<UXHandleHoop> m_UXOrderedQueue;
    UXHandleHoop m_CurrentHandle;
    ...
    void OnEnable()
    {
        ...
        PlaceHoop.onPlacedObject += () => m_PlacedObject = true;

        GetManagers();
        m_UXOrderedQueue = new Queue<UXHandleHoop>();

        if (m_StartWithInstructionalUI)
        {
            m_UXOrderedQueue.Enqueue(new UXHandleHoop(m_InstructionalUI, m_InstructionalGoal));
        }

        if (m_ShowSecondaryInstructionalUI)
        {
            m_UXOrderedQueue.Enqueue(new UXHandleHoop(m_SecondaryInstructionUI, m_SecondaryGoal));
        }
    }
    ...
    public void AddToQueue(UXHandleHoop uxHandleHoop)
    {
        m_UXOrderedQueue.Enqueue(uxHandleHoop);
    }
